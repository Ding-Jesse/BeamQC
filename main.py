...
if __name__ == '__main__':
    ...
    plan_filenames = [
        r'D:\Desktop\BeamQC\TEST\2023-0310\岡山(南基地)-XS-PLAN-TEST.dwg']
    # sys.argv[3] # XS-BEAM_new的路徑
    beam_new_filename = r"D:\Desktop\BeamQC\TEST\XS-BEAM_new.dwg"
    # sys.argv[4] # XS-PLAN_new的路徑
    plan_new_filename = r"D:\Desktop\BeamQC\TEST\XS-PLAN_new.dwg"
    ...
    main_functionV3(beam_filenames=beam_filenames,
                    ...
                    output_directory=r"D:\Desktop\BeamQC\TEST\2024-0514",
                    layer_config=layer_config,
                    progress_file=progress_file,
                    sizing=sizing,
                    mline_scaling=mline_scaling,
                    client_id="2024-0514-temp")
