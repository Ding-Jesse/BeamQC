...
if __name__ == '__main__':
    ...
    col_filename = r'D:\Desktop\BeamQC\TEST\2023-0626\2023-0309.dwg'
    column_filenames = [
        # sys.argv[1] # XS-COL的路徑
        r'D:\Desktop\BeamQC\TEST\2023-0626\2023-0309.dwg',
    ...
    floor_parameter_xlsx = r'D:\Desktop\BeamQC\TEST\2023-0626\五股登林樓層參數_floor (1).xlsx'
    output_folder = r'D:\Desktop\BeamQC\TEST\2023-0617'
    project_name = '0717-五股_柱'
    # layer_config = {
    ...
    sort_col_cad(msp_column=msp_column,
                 doc_column=doc_column,
                 layer_config=layer_config,
                 temp_file=r'D:\Desktop\BeamQC\TEST\2023-0617\0717-column.pkl')
    ...
    column_list = cal_column_rebar(data=save_temp_file.read_temp(r'D:\Desktop\BeamQC\TEST\2023-0617\0717-column.pkl'),
                                   rebar_excel_path=floor_parameter_xlsx)
