...
def cal_beam_rebar(data={},progress_file='',rebar_parameter_excel=''):
    ...
    progress('整理線段與鋼筋標示箭頭', progress_file)
    ...
    try:
        ...
        print('NoRebarData')
    progress('整理鋼筋文字與鋼筋標示箭頭', progress_file)
    ...
    #截斷處重複計算
    progress('整理彎折鋼筋與直線鋼筋', progress_file)
